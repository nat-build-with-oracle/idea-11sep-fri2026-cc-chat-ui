...
export type IconName = 'new' | 'search' | 'folder' | 'chevron' | 'plus' | 'arrow' | 'stop' | 'close' | 'panel' | 'info' | 'settings' | 'terminal' | 'message' | 'copy' | 'check' | 'shield' | 'lock' | 'more' | 'download' | 'trash' | 'refresh' | 'agents' | 'file' | 'back'
